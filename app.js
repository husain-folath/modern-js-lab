...
//
// b. Console log the `firstIngredient` and `secondIng  redient` variables.
//
// Starting code (don't modify this):
...
//we set the language variable before we check it to avoid reference error
...
// to choose the en if there is no value for localLangCongif
